...
const socialLinks = [
  ...
  { name: 'Codeberg', id: 'itxLikhith', url: 'https://codeberg.org/itxLikhith', icon: <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M11.996 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-3.084 18.257l2.124-7.854 2.124 7.854h-4.248zm6.541 0l-2.022-7.464 2.022-3.829 4.341 11.293h-4.341z" /></svg> },
